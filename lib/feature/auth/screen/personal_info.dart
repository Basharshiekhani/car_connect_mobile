...
class _PersonalInfoState extends State<PersonalInfo> {
  ...
  bool isIdImageAdded = false;
  bool isCommercialRegisterAdded = false;

  void showImageAddedMessage() {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        backgroundColor: AppColorManager.green,
        content: AppTextWidget(
          text: "تم إضافة الصورة بنجاح",
                      ...
                      children: [
                        ...
                        MainAppDottedButton(
                          onTap: () async {
                            ...
                            if (commercialRegister != null) {
                              setState(() {
                                isCommercialRegisterAdded = true;
                              });
