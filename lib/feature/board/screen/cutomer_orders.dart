...
class _CarOrdersScreenState extends State<CustomerOrdersScreen> {
  ...
  void getOrders() async {
    ...
    print("API URL: ${ApiPostUrl.getOrderByUserId}");
    
    Map<String, dynamic> requestBody = {"userId": AppSharedPreferences.getUserId()};
          ...
          try {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                backgroundColor: AppColorManager.white,
                content: AppTextWidget(
                  text: "Error processing server response: $e",
                  color: AppColorManager.navy,
                  fontSize: FontSizeManager.fs16,
                  fontWeight: FontWeight.w600,
                  overflow: TextOverflow.visible,
